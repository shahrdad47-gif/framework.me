    ...
    sections: {
      ...
      videoTeachings: {
        ...
        categories: {
          ...
          'forerunner-message':   { label: 'پیام پیشرو',             desc: 'ندایی نبوی برای آماده‌سازی راه بازگشت عیسی، در روح یحیای تعمیددهنده.' },
        },
    ...
    sections: {
      ...
      videoTeachings: {
        ...
        categories: {
          ...
          'forerunner-message':   { label: 'Կանխորդի Պատգամ', desc: 'Մարգարեական կոչ՝ պատրաստելու Հիսուսի վերադարձի ճանապարհը, Հովհաննես Մկրտչի հոգով:' },
        },
    ...
    sections: {
      ...
      videoTeachings: {
        ...
        categories: {
          ...
          'forerunner-message':   { label: 'Mensagem do Precursor',       desc: 'Um chamado profético para preparar o caminho para o retorno de Jesus, no espírito de João Batista.' },
        },
    ...
    sections: {
      ...
      videoTeachings: {
        ...
        categories: {
          ...
          'forerunner-message':   { label: 'رسالة السابق',                desc: 'دعوة نبوية لتمهيد الطريق لعودة يسوع، بروح يوحنا المعمدان.' },
        },
