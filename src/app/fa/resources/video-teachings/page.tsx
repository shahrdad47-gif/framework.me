    ...
    <div className="res-sub-page" dir={t.dir}>
      <div className="res-sub-hero">
        ...
        <div className="container res-sub-hero-inner">
          <BackButton fallbackHref="/fa/resources" label={s.back.replace(/^[←→]\s*/, '')} className="res-sub-back" rtl={t.dir === 'rtl'} />
      ...
      <div className="container res-sub-body">
        <VideoTeachings categoryNames={s.categories} dir={t.dir} videoLabel={s.video} videosLabel={s.videos} searchPlaceholder={s.searchPlaceholder} searchHints={s.searchHints} localePrefix="/fa" />
      </div>
    </div>
  )
}
