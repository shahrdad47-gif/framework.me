  ...
  return (
    <div className="res-sub-page" dir={t.dir}>
      ...
      <div className="container res-sub-body">
        <VideoTeachings categoryNames={s.categories} dir={t.dir} videoLabel={s.video} videosLabel={s.videos} searchPlaceholder={s.searchPlaceholder} searchHints={s.searchHints} localePrefix="/ar" />
      </div>
    </div>
  )
}
